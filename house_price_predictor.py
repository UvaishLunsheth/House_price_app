...
# ✅ Load pipeline from Google Drive
@st.cache_resource
def load_pipeline_from_drive():
    url = "https://drive.google.com/uc?id=1WJ-2CoZjeVN8_F1xlUbz6wvtiY_U_n14"  # Make sure this is direct-download link
...
pipeline = load_pipeline_from_drive()
